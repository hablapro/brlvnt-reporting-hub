...
- **Basis note (important):** June client materials report Azerion at **raw vendor cost** ($34,556) per approved narrative; May client deck was fee-inclusive ($29,302). All June MoM uses the raw basis consistently; documented in the Sheet's Data Notes and the tracker note.
