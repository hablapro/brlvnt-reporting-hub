...
- **Deck (working draft)** — Google Slides `1iNeaobJVJLF_Dr3NU2W6Wutsvh55xqJhRFGOL-P_mug` + source PPTX `1yxhTuN7OxLffoAWQz9mZcT67puzJPxWu` (local: `report-client-decks/06. GGMI_LATAM_June_2026_Performance_Review.pptx`). **16 slides = June review + Q3 FY2026 QBR section (added 2026-07-16, Renzo-planned):** S1-10 June (final-May structure), S11 Q3 Spend (client tracker: Apr $46,294 / May $78,790 / Jun $120,393 / Q3 $245,477 ≈ 24% of FY), S12 Q3 Applications (per-channel + blended 20/71/103 = 194, blended cost/app $2,315→$1,169, Q3 $1,265), S13 Blended Outcomes vs Plan (client Budget-vs-Actual dashboard, GGMI organic+paid, FUNNEL ROWS ONLY — client's Marketing Spend rows excluded per Renzo, their spend feed conflicts with ours; Q3: apps 2,167/3,984 -46%, funded 106/240 -56%, traded 100/180 -44%, actives 399/485 -18%, volume $4.3B/$6.7B -36%; July excluded = forecast), S14 Site Traffic six-month, S15 Organic Search / SEO workstream (GSC -75%, content decay + mid-funnel rank slide), S16 close. No Q4 teaser (Renzo: retrospective only). Meta conversions "Held"; Bing geo framed as efficiency lever. Renzo reviews/edits the Slides and sends.
